...
type DCRResponse struct {
	ClientID     string `json:"client_id"`               // REQUIRED: OAuth client identifier
	ClientSecret string `json:"client_secret,omitempty"` // OPTIONAL: Client secret (omitted for public clients)
	// Additional fields omitted for brevity - we only need client_id for public clients
}
